...
class FlaskThread(Thread):
  ...
  def __init__(self, settings, port):
    ...
    self._app.add_url_rule("/", view_func=IndexAPI.as_view('index',self._settings))
...
class IndexAPI(MethodView):
  ...
  def get(self):
    ...
    return send_from_directory("/usr/local/lib/python2.7/site-packages/nclock/static/", "index.html")
    # FIXME(benjaminfuchs) This seems a poor solution, find a better one
