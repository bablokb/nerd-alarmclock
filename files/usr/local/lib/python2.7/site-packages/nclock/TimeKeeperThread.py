...
class TimeKeeperThread(Thread):
  ...
  def __init__(self,settings):
    ...
    self._settings.add_settings_listener("day.start",on_day_limit)
    self._settings.add_settings_listener("day.end",on_day_limit)
  ...
  def _set_day_mode(self,now):
    ...
    if self._day_start <= now and now <= day_end:
      new_mode = "day"
    else:
      new_mode = "night"
