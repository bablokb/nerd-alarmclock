...
class KeyboardThread(Thread):
  ...
  def btn1_def(self,state,stime,rtime):
    ...
    if state == "1":
      self._settings.log.msg("Button 1, ignoring state 1")
      return
  ...
  def btn1_ovl1(self,state,stime,rtime):
    ...
    self._settings.log.msg("Button 1, ovl1 function")
  ...
  def btn2_ovl1(self,state,stime,rtime):
    """ process overlay action for button 2 """
    self._settings.log.msg("Button 2, ovl1 function")
  ...
  def btn3_ovl1(self,state,stime,rtime):
    """ process overlay action for button 3 """
    self._settings.log.msg("Button 3, ovl1 function")
    self.cycle_led_mode()
  ...
  def btn4_ovl1(self,state,stime,rtime):
    ...
    self._settings.log.msg("Button 4, ovl1 function")
  ...
  def _toggle_state(self,stime,nr):
    ...
    self._settings.log.msg("_toggle_state() for button %d, with stime=%g" %
                           (nr,stime))
    if stime > 5:
      ...
      if self._state == "def":
        ...
        self._settings.log.msg("Button %d, changed state to ovl%d", (nr,nr))
      else:
        self._state = "def"
        self._settings.set("_do_config","off")
        self._settings.log.msg("Button %d, changed state to def",nr)
      return True
    else:
      return False
