...
class KeyboardThread(Thread):
  ...
  def btn1_def(self,state,stime,rtime):
    """ process default action for button 1 """
    self._settings.log.msg("KeyboardThread: Button 1, default function")

    # only react to state==0 and decide, if short or long press
    if state == "1":
      self._settings.log.msg("KeyboardThread: Button 1, ignoring state 1")
      return
    if not self._toggle_state(float(stime),1):
      # normal short-press event
      self.change_alarm_state("1")

  # --- process overlay1 action for button 1   -----------------------------

  def btn1_ovl1(self,state,stime,rtime):
    """ process overlay action for button 1 """
    self._settings.log.msg("KeyboardThread: Button 1, ovl1 function")
  ...
  def btn2_def(self,state,stime,rtime):
    """ process default action for button 2 """
    self._settings.log.msg("KeyboardThread: Button 2, default function")
    self.change_alarm_state("2")

  # --- process overlay action for button 2   ------------------------------

  def btn2_ovl1(self,state,stime,rtime):
    """ process overlay action for button 2 """
    self._settings.log.msg("KeyboardThread: Button 2, ovl1 function")
  ...
  def btn3_def(self,state,stime,rtime):
    """ process default action for button 3 """
    self._settings.log.msg("KeyboardThread: Button 3, default function")
    self.change_alarm_state("3")

  # --- process overlay action for button 3   ------------------------------

  def btn3_ovl1(self,state,stime,rtime):
    """ process overlay action for button 3 """
    self._settings.log.msg("KeyboardThread: Button 3, ovl1 function")
    self.cycle_led_mode()
  ...
  def btn4_def(self,state,stime,rtime):
    """ process default action for button 4 """
    self._settings.log.msg("KeyboardThread: Button 4, default function")
    self.change_alarm_state("4")

  # --- process overlay 1 action for button 4  ------------------------------

  def btn4_ovl1(self,state,stime,rtime):
    """ process overlay action for button 4 """
    self._settings.log.msg("KeyboardThread: Button 4, ovl1 function")
    self.cycle_display_mode()

  # --- toggle button state   ----------------------------------------------

  def _toggle_state(self,stime,nr):
    """ toggle state of buttons if long pressed (return True if handled)"""

    self._settings.log.msg(
      "KeyboardThread: _toggle_state() for button %d, with stime=%g" %
                           (nr,stime))
    if stime > 5:
      # ignore very long press, typically an artifact during init
      self._settings.log.msg("KeyboardThread: Button 4, ignoring stime > 5")
      return True
    elif stime > 1:
      # toggle overlay state
      if self._state == "def":
        self._state = "ovl%d" % nr
        self._settings.set("_do_config","on")
        self._settings.log.msg(
          "KeyboardThread: Button %d, changed state to ovl%d" % (nr,nr))
      else:
        self._state = "def"
        self._settings.set("_do_config","off")
        self._settings.log.msg(
          "KeyboardThread: Button %d, changed state to def" % nr)
      return True
    else:
      return False
  ...
  def change_alarm_state(self,button):
    ...
    self._settings.log.msg("KeyboardThread: changing state of button %s" % button)
  ...
  def cycle_display_brightness(self):
    self._settings.log.msg("KeyboardThread: changing display brightness")
  ...
  def cycle_led_brightness(self):
    self._settings.log.msg("KeyboardThread: changing led brightness")
    mode = self._settings.get("_day_mode")
  ...
  def cycle_display_mode(self):
    self._settings.log.msg("KeyboardThread: changing display mode")

  # --- cylcle LED brightness   -------------------------------------------

  def cycle_led_mode(self):
    self._settings.log.msg("KeyboardThread: changing led mode")
