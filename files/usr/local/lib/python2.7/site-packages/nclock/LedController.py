...
class LedController(object):
  ...
  def __init__(self,settings):
    ...
    settings.add_settings_listener('led_brightness_day',self.on_brightness)
    settings.add_settings_listener('led_brightness_night',self.on_brightness)
  ...
  def _initialize(self):
    ...
    if day_start <= current_time and current_time <= day_end:
      self.set_brightness(self._settings.get("led_brightness_day"))
    else:
      self.set_brightness(self._settings.get("led_brightness_night"))

  # --- set the time   -----------------------------------------------------

  def set_time(self,t):
    """ show the given time (or whatever) on the led """

    self._settings.log.msg("Setting time to: %s" % t)
    if not simulate:
      # TODO: implement
      pass
