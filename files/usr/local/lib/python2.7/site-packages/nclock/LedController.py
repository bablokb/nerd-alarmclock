...
class LedController(object):
  ...
  def on_day_mode(self,name,old,new):
    ...
    value = self._settings.get("led.brightness."+name)
  ...
  def on_date(self,name,old,new):
    ...
    # set day-of-month
    self._day_of_month = int(new[0].split(':')[2])
    self._set_day_of_month()
  ...
  def get_alarm(self,nr,alarm):
    ...
    # return alarm
    t = threading.Thread(target=target,args=(alarm.event,),kwargs=**cfg)
    return t

  # sunrise simulation   ---------------------------------------------------

  def sunrise(self,stop_me,duration=10):
  ...
  def police(self,stop_me,duration=5):
