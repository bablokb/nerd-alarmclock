...
class SoundController(object):
  ...
  def __init__(self,settings):
    ...
    self._mpg123_opts = settings.get_value('GLOBAL','mpg123_opts','')
  ...
  def _get_sounds(self):
    ...
    self._sound_dir = self._settings.get_value('GLOBAL','sounds',sounds_default)
  ...
  def play_sound(self,stop_me,name=None,duration=10,volume=40):
    ...
    if simulate:
      ...
      with self._lock:
        ...
        args = shlex.split("amixer -q set PCM %s%%" % volume)
        subprocess.call(args)

        # start playing sound
        args = shlex.split("mpg123 -q --loop -1 %s %s" %
                                               (self._mpg123_opts,sound_file))
        ...
        # stop playing sound
        try:
          os.killpg(prog.pid, signal.SIGKILL)
          prog.wait()
        except:
          pass
