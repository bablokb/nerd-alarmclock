...
class BotThread(Thread):
  ...
  def _do_alarm_time_callback(self,query_id,chat_id,value):
    ...
    if value == 'ok':
      ...
      self._bot.sendMessage(chat_id,_("new time: %s") % self._alarm_time)
    else:
      # save digit
  ...
  def _do_alarm_days_callback(self,query_id,chat_id,value):
    ...
    if value == 'ok':
      ...
      self._bot.sendMessage(chat_id,_("selected days: %s") % self._alarm_days)
    elif value == " ":
      pass
    else:
      # save in list
  ...
  def _do_alarm_dur_callback(self,query_id,chat_id,value):
    ...
    if value == 'ok':
      ...
      self._settings.set("alarm.%s.led" % self._alarm_nr,self._led_cfg)
      self._bot.sendMessage(chat_id,_("new duration: %s") % self._alarm_dur_new)
    elif value == " ":
      pass
    else:
      # save digit
