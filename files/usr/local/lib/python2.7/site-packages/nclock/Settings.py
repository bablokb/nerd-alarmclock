...
class Settings(object):
  ...
  def __init__(self,parser):
    ...
    # private fields
    self.__time_change_listener = []             # calls backs for time change
    self.__values   = {}
    self.__listener = {}
    self.__lock     = Lock()
  ...
  def add_settings_listener(name,func):
  ...
  def add_timechange_listener(name,func):
    """ add a change-listener for time changes """

    with self.__lock:
      sef.__time_change_listeners.append(func)
